...
import { FlexLayout, FlexItem } from "@heswell/uitk-core";
import {
  CSSClassTable,
  CSSVariableTable,
...
The flex layout supports the use of responsive props, so you can define different behaviors based on viewport size.
