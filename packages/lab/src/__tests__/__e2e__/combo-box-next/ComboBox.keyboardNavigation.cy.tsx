...
import * as comboBoxStories from "@stories/combobox-next.stories";
    ...
    describe("when focused and ArrowDown key is pressed", () => {
      it("should start highlighting from the first item", () => {
        ...
        cy.findByRole("listbox")
          ...
          .should("have.class", "uitkListItemNext-highlighted")
    ...
    describe("when focused", () => {
      it("should not highlight any item with a focus ring", () => {
        ...
        cy.findByRole("listbox")
          ...
          .should("not.have.class", "uitkListItemNext-highlighted");
      });
    });
    ...
    describe("when the 'Enter' key is pressed", () => {
      ...
      it("should select the highlighted item", () => {
        ...
        cy.findByRole("listbox")
          ...
          .should("have.attr", "aria-selected", "true")
          .and("have.class", "uitkListItemNext-highlighted");
      });
    });
