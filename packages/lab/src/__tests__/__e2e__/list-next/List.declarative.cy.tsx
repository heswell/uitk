import {
  ListNext as List,
  ListItemNext as ListItem,
} from "@jpmorganchase/uitk-lab";

const HIGHLIGHTED = "uitkListItemNext-highlighted";
const DISABLED = "uitkListItemNext-disabled";
...
describe("A disabled declarative list", () => {
  ...
  it("should have the disabled list style", () => {
    cy.findByRole("listbox").should("have.class", "uitkListNext-disabled");
  });
