...
export interface DropdownButtonNextProps extends ButtonProps<"div"> {
  /**
...
const withBaseName = makePrefixer("uitkDropdownButtonNext");

export const DropdownButtonNext = forwardRef(function DropdownButton(
  {
