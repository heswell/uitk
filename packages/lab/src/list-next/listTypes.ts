...
> extends SelectionProps<Item, Selection>,
   ...
   */
  //FIXME How do I type this - I want to say it is a React.FC whose props must extend ListItemProps
  ListItem?: any;
  /**
  ...
  onMouseEnterListItem?: (event: React.MouseEvent, idx: number) => void;
  /**
