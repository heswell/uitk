...
<Meta title="Experimental/Dropdown Next/Doc" component={DropdownList} />

# List

How are the dimensions of a DropdownList calculated
...
- listWidth
  ...
  If width is set. width is set via inline style on Button (triggerControl) . DropdownList root element is inline-block, so width of Button determines width of root element
