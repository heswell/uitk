...
<Meta title="Lab/Input/Doc" component={Input} />
...
- [Focused](/docs/themes-toolkit-characteristics--focused)
  - --uitk-focused-outline-color
  - --uitk-focused-outline-style
  - --uitk-focused-outline-width
  - --uitk-focused-outline-offset
- [Text](/docs/themes-toolkit-characteristics--text)
  - --uitk-text-font-size
  - --uitk-text-primary-color
  - --uitk-text-background-selected
- [Disabled](/docs/themes-toolkit-characteristics--selectable)
  - --uitk-selectable-cursor-disabled
...
.uitk-dark.uitk-newapp {
  ...
  --uitkInput-border-radius: 5px;
  --uitkInput-focused-outline-color: var(--uitk-color-green-100);
  --uitkInput-highlight-color: var(--newapp-highlight-color);
  --uitkInput-font-family: arial;
}
