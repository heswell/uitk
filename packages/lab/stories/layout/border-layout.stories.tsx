...
const TwoColumnFormPage: ComponentStory<typeof BorderLayout> = (args) => {
  return (
    <BorderLayout {...args}>
      ...
      >
        <Header />
        <div className="border-layout-button-container">
          <Button variant="secondary">
      ...
      <BorderItem position="main">
        <FlowLayoutComposite separators gap={3} />
      </BorderItem>
...
export const BorderLayoutComposite = TwoColumnFormPage.bind({});
BorderLayoutComposite.args = {};
