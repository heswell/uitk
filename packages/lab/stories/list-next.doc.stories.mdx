...
<Meta title="Experimental/List Next/Doc" component={ListNext} />
...
<Canvas>
  <ToolkitProvider>
    <ListNext aria-label="Declarative List example">
...
10 \* 36 default row count - default item height
9 \* 1 inter-item gaps
2 default border 1px top and bottom

# API

```
import { ListNext } from "@jpmorganchase/uitk-core";
```
