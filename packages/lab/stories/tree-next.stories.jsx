...
import { TreeNext as Tree } from "@jpmorganchase/uitk-lab";
import { usa_states_cities, groupByInitialLetter } from "./list-next.data";
import { folderData } from "./tree-next.data";

import "./list-next.css";

export default {
  title: "Experimental/Tree Next",
  component: Tree,
};
